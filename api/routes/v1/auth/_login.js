...
import { JERROR_BAD_REQUEST, JERROR_METHOD_NOT_ALLOWED } from '../../../lib/error'
...
router.post('/', async ({ body: { username, password } }, res) => {
    ...
    return JERROR_BAD_REQUEST(res, 'no username and or no password specified in the request.')
})

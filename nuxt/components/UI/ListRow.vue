<template>
    <div class="list-row list-row-hover menu-list-height">
        <div style="width: 100px" class="list-item">
            ...
            <i v-if="type === 'Folder'" class="folder-icon"></i>
            <i v-if="type === 'File'" class="file-icon"></i>
        </div>
        ...
        <div style="width: 100px" class="list-item">
            <i v-if="scanStatus == 0" class="status-icon-accepted"></i>
            <i v-if="scanStatus == 1" class="status-icon-progress"></i>
            <i v-if="scanStatus == 2" class="status-icon-attention"></i>
        </div>
        <div style="width: 100px" class="list-item">

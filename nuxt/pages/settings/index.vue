    ...
    <main>
        ...
        <div class="overview">
            <div class="center-container"
                ...
                <settings-data-change-form v-model="changeName"
                                           ...
                                           iconClass="public"></settings-data-change-form>

                <settings-data-change-form v-model="changeEmail"
                ...
                <div class="spacer-container">
                    ...
                    <span class="disclaimer">Ihr Passwort stellt den Hauptschlüssel für Ihren Account dar.<br>
                        <b>Geben Sie dieses Passwort niemals an Dritte weiter!</b>
                    </span>
                    <input @click="changePasswordSubmit = true"
